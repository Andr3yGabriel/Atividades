...
elif sobra >= (salario*0.1) and sobra < (salario*0.3):
    print(f'Você utilizou {sobrapercentual}% do seu salário, tente guardar uma parte desse dinheiro para emergências.')

elif sobra > (salario*0.3) and sobra < (salario*0.5):
    print(f'Parabéns, você tem {sobrapercentual}% de seu dinheiro sobrando para guardar e gastar com lazer.')
